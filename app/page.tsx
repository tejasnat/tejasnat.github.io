        ...
        <div className="shell personal-hero">
          ...
          <div className="hero-profile-grid">
            ...
            <div className="hero-summary">
              ...
              <p>During my internship at AZAD Engineering, I gained exposure to the manufacturing and inspection of precision aerospace components, including multi-axis CNC machining, airfoil geometry, CMM inspection, and process quality control.</p>

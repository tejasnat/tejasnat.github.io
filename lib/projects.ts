...
export const projects: Project[] = [
  {
    slug: "tesla-turbine",
    number: "01",
    title: "Evaluating a Tesla Turbine Through CAD and CFD",
  ...
  },
  {
    ...
    number: "02",
    title: "Detecting Aerodynamic Stall and Predicting Lift",
    shortTitle: "Aerodynamic Stall ML",
    category: "ML & Data",
    date: "Academic project",
    summary: "A two-stage machine-learning workflow using UIUC airfoil data to classify pre- and post-stall behaviour and predict lift across three Reynolds-number regimes.",
    brief: "The model separates the aerodynamic regime before predicting lift, reflecting the fact that pre-stall and post-stall behaviour follow different trends.",
    tools: ["Python", "scikit-learn", "Classification", "Regression"],
    focus: ["Lift prediction", "Stall classification", "Reynolds number", "Physical consistency"],
    visual: "airfoil",
    challenge: "Identify the onset of stall and predict lift across strongly non-linear aerodynamic regimes without forcing one regression model to represent both pre- and post-stall behaviour.",
    approach: [
      "Prepared UIUC polar data for a NACA 0012-64 baseline across Reynolds numbers of 50k, 100k and 500k.",
      "Built a first-stage classifier for pre- versus post-stall behaviour, followed by region-specific lift regression.",
      "Compared predicted behaviour with the observed stall angle and maximum lift in each Reynolds-number regime.",
    ],
    findings: [
      "Observed stall shifted from 8° at Re 50k to 13.75° at Re 500k, with maximum lift increasing across the same range.",
      "Separating aerodynamic regimes made the modelling logic more consistent with the change in flow behaviour after stall.",
      "Prediction quality still depends on data coverage and should not be treated as a substitute for aerodynamic validation.",
    ],
    ...
    facts: [
      { label: "Dataset", value: "UIUC polars" },
      { label: "Reynolds range", value: "50k · 100k · 500k" },
      { label: "Outputs", value: "Stall state + lift" },
    ],
  },
  {
    slug: "joule-heating-multiphysics",
    number: "03",
    title: "Coupled Electro-Thermal Analysis of a Conductive Plate",
  ...
  },
  {
    ...
    number: "05",
    title: "Mechanical Packaging for an Autonomous Underwater Vehicle",
